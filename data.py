...
class Data:
	...
	# This function uses boolean masking to split the courses into undergrad and grad courses.
	...
	# This function uses boolean masking to split the grader info into Masters and Doctoral Students.
